const u8 gSpeciesNames[][POKEMON_NAME_LENGTH + 1] = {
    ...
    [SPECIES_NEWTTLE] = _("Newttle"),
    [SPECIES_SAPRICKLE] = _("Saprickle"),
    [SPECIES_MOLCHARGE] = _("Molcharge"),
};
