...
// Gen III
    ...
    //New Pokemon
    SPECIES_SPRITE(NEWTTLE,       gMonStillFrontPic_Newttle),
    SPECIES_SPRITE(SAPRICKLE,     gMonStillFrontPic_Saprickle),
    SPECIES_SPRITE(MOLCHARGE,     gMonStillFrontPic_Molcharge),
