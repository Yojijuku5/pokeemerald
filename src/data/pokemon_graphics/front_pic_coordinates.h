...
const struct MonCoords gMonFrontPicCoords[] =
{
    ...
    //New Pokemon
    [SPECIES_NEWTTLE]     = { .size = MON_COORDS_SIZE(48, 48), .y_offset =  8 },
    [SPECIES_SAPRICKLE]   = { .size = MON_COORDS_SIZE(48, 48), .y_offset = 8 },
    [SPECIES_MOLCHARGE]   = { .size = MON_COORDS_SIZE(48, 48), .y_offset = 8 },
