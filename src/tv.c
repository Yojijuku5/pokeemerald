...
u8 CheckForPlayersHouseNews(void)
{
    ...
    if (gSaveBlock1Ptr->location.mapGroup != MAP_GROUP(MAP_MODELLA_TOWN_PLAYERS_HOUSE_1F) && gSaveBlock1Ptr->location.mapNum != MAP_NUM(MAP_MODELLA_TOWN_PLAYERS_HOUSE_1F))
