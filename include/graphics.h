...
//New Pokemon
extern const u32 gMonFrontPic_Newttle[];
extern const u32 gMonPalette_Newttle[];
extern const u32 gMonBackPic_Newttle[];
extern const u32 gMonShinyPalette_Newttle[];
extern const u32 gMonStillFrontPic_Newttle[];
extern const u8 gMonIcon_Newttle[];
extern const u8 gMonFootprint_Newttle[];
extern const u32 gMonFrontPic_Saprickle[];
extern const u32 gMonPalette_Saprickle[];
extern const u32 gMonBackPic_Saprickle[];
extern const u32 gMonShinyPalette_Saprickle[];
extern const u32 gMonStillFrontPic_Saprickle[];
extern const u8 gMonIcon_Saprickle[];
extern const u8 gMonFootprint_Saprickle[];
extern const u32 gMonFrontPic_Molcharge[];
extern const u32 gMonPalette_Molcharge[];
extern const u32 gMonBackPic_Molcharge[];
extern const u32 gMonShinyPalette_Molcharge[];
extern const u32 gMonStillFrontPic_Molcharge[];
extern const u8 gMonIcon_Molcharge[];
extern const u8 gMonFootprint_Molcharge[];
